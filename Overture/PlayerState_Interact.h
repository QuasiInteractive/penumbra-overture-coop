...
private:
	...
	/** Multiplayer guest holding a replicated body: the grab is FORWARDED to
	    the host (no local forces); motion comes back via body sync. Always
	    false on the host / offline. */
	bool mbNetForwarded;
...
private:
	...
	/** Multiplayer guest: forces are forwarded as impulses, none applied locally. */
	bool mbNetForwarded;
